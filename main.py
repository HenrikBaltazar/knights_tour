...
class KnightTourApp:
    ...
    def _build_ui(self):
        ...
        ttk.Label(
            header,
            text="Knight's Tour - Backtracking + Warnsdorff",
            font=("Consolas", 9),
            bootstyle="secondary",
        ...
        stat_items = [
            ...
            ("Total de Movimentos", "moves", "0"),
            ("Complexidade (Big-O)", "complexity", "O(N^2)"),
        ]
        self.stat_labels = {}
        ...
        ttk.Label(
            stats, text="Heuristica de Warnsdorff",
            font=("Consolas", 8, "italic"), bootstyle="secondary",
    ...
    def _after_solve(self, success, board, path, exec_time, n):
        self.stat_labels["exec_time"].config(text=f"{exec_time:.2f} ms")
        self.stat_labels["moves"].config(text=str(n * n if success else len(path)))
